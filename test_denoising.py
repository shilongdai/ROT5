...
if __name__ == "__main__":
    tokenizer = AutoTokenizer.from_pretrained("./rebert_tinystories_best")
    tokenizer.padding_side = "right"
    collate_fn = DataCollatorForUL2(tokenizer, sentinel_map=lambda x: x + 2, decoder_start_token_id=32001)
