...
if __name__ == "__main__":
    ...
    collate_fn = DataCollatorForUL2(tokenizer, sentinel_map=lambda x: x + 2, r_probability=0.9, s_probability=0.05, x_probability=0.05)
    ...
    encode = collate_fn([ { 'input_ids': tokenizer(r)['input_ids'][:np.random.randint(50, 200)] } for r in batch] )
