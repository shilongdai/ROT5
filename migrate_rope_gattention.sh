...
deepspeed migrate_mlm.py --output_dir="./rebert_roberta" --final_output_dir "./rebert_roberta_best" \
  --evaluation_strategy "steps" --per_device_train_batch_size 60 --per_device_eval_batch_size 60 \
  --gradient_accumulation_steps 68 --max_grad_norm 0.5 \
  --learning_rate 0.001 --num_train_epochs 2 --weight_decay 0.01 --warmup_ratio 0.5 --lr_scheduler_type "linear" \
