...
deepspeed train_mlm.py --output_dir="./rebert_minipile_128" --final_output_dir "./rebert_minipile_best_128" \
  ...
  --learning_rate 0.001 --num_train_epochs 1 --weight_decay 0.01 --warmup_ratio 0.02 --lr_scheduler_type "linear" \
...
deepspeed train_mlm.py --output_dir="./rebert_minipile_256" --final_output_dir "./rebert_minipile_best_256" \
  ...
  --gradient_accumulation_steps 1 \
  --learning_rate 0.0005 --num_train_epochs 1 --weight_decay 0.01 --warmup_ratio 0.02 --lr_scheduler_type "linear" \
