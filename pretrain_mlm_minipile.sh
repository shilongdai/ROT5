...
deepspeed train_mlm.py --output_dir="./rebert_minipile_128" --final_output_dir "./rebert_minipile_best_128" \
  ...
  --learning_rate 0.001 --num_train_epochs 1 --weight_decay 0.01 --lr_scheduler_type "reduce_lr_on_plateau" \
...
deepspeed train_mlm.py --output_dir="./rebert_minipile_256" --final_output_dir "./rebert_minipile_best_256" \
  ...
  --gradient_accumulation_steps 1 \
  --learning_rate 0.0005 --num_train_epochs 1 --weight_decay 0.01 --lr_scheduler_type "reduce_lr_on_plateau" \
...
deepspeed train_mlm.py --output_dir="./rebert_minipile_512" --final_output_dir "./rebert_minipile_best_512" \
  ...
  --gradient_accumulation_steps 1 \
  --learning_rate 0.0001 --num_train_epochs 1 --weight_decay 0.01 --lr_scheduler_type "reduce_lr_on_plateau" \
...
deepspeed train_mlm.py --output_dir="./rebert_minipile_800" --final_output_dir "./rebert_minipile_best_800" \
  --evaluation_strategy "steps" --per_device_train_batch_size 200 --per_device_eval_batch_size 200 \
  --gradient_accumulation_steps 1 \
  --learning_rate 0.0001 --num_train_epochs 1 --weight_decay 0.01 --warmup_ratio 0.02 --lr_scheduler_type "linear" \
...
deepspeed train_mlm.py --output_dir="./rebert_minipile_1600" --final_output_dir "./rebert_minipile_best_1600" \
  ...
  --learning_rate 0.00005 --num_train_epochs 1 --weight_decay 0.01 --warmup_ratio 0.02 --lr_scheduler_type "linear" \
  --logging_dir "tb_rebert_minipile" --logging_steps 100 \
  --save_steps 100 --save_strategy "steps" --save_total_limit 10 --load_best_model_at_end False \
  --bf16 True --gradient_checkpointing True --deepspeed "./deepspeed/deepspeed_2.json" \
  --dataset_path "data/minipile" --eval_name "validation" --model_path "./rebert_minipile_best_800"

deepspeed train_mlm.py --output_dir="./rebert_minipile_2400" --final_output_dir "./rebert_minipile_best_2400" \
  --evaluation_strategy "steps" --per_device_train_batch_size 200 --per_device_eval_batch_size 200 \
  --gradient_accumulation_steps 3 \
  --learning_rate 0.00005 --num_train_epochs 1 --weight_decay 0.01 --warmup_ratio 0.02 --lr_scheduler_type "linear" \
  --logging_dir "tb_rebert_minipile" --logging_steps 50 \
  --save_steps 50 --save_strategy "steps" --save_total_limit 10 --load_best_model_at_end False \
  --bf16 True --gradient_checkpointing True --deepspeed "./deepspeed/deepspeed_2.json" \
  --dataset_path "data/minipile" --eval_name "validation" --model_path "./rebert_minipile_best_1600"
