#!/bin/bash
 ...
 deepspeed train_ul2.py --output_dir="./grot5_tinystories" --final_output_dir "./grot5_tinystories_best" \
   ...
   --logging_dir "tb_grot5_tinystories" --logging_steps 100 --generation_max_length 512 \
   ...
   --tokenizer_name "mistralai/Mistral-7B-Instruct-v0.2" --kv_heads 4
