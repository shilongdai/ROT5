#!/bin/bash
 ...
 deepspeed train_ul2.py --output_dir="./rot5_tinystories" --final_output_dir "./rot5_tinystories_best" \
   ...
   --logging_dir "tb_rot5_tinystories" --logging_steps 100 --generation_max_length 512 \
