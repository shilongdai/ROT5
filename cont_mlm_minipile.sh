#!/bin/bash
 ...
 deepspeed train_mlm.py --output_dir="./rebert_minipile" --final_output_dir "./rebert_minipile_best" \
   ...
   --learning_rate 0.001 --max_steps 18600 --weight_decay 0.01 --warmup_ratio 0.01 --lr_scheduler_type "linear" \
   ...
   --dataset_path "data/minipile_mistral" --eval_name "validation" --model_path "./minipile-1"
